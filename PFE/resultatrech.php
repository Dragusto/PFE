...
$sql = "SELECT  * FROM questionnaire WHERE id = '$id_search'";
$tab = mysqli_query($db_handle, $sql);
$row = mysqli_fetch_array($tab);
$r1 = $row['q1'];
$r2 = $row['q2'];
$r3 = $row['q3'];
$r4 = $row['q4'];
$sql2 = "SELECT  * FROM membre WHERE id = '$id_search'";
$tab2 = mysqli_query($db_handle, $sql2);
$row2 = mysqli_fetch_array($tab2);
$nomsearch = $row2['nom'];
$prenomsearch = $row2['prenom'];
...
<!-- Cas 1  Infirmier-->
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un infirmier.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un exécutant.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un gardien.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est une personne aide à domicile.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un mécanicien.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un homme d'action.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un acteur.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un contemplatif.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un directeur.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un scientifique</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un visionnaire.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un penseur.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un donateur.</p>
		...
		{?>
			<p> <?php echo $nomsearch.' '.$prenomsearch;?> est un protecteur.</p>
