	...
	<form enctype="multipart/form-data" action="questionnaire3Traitement.php" method="post">
		...
		<fieldset>
			<p>
				<table>
					<tr>
					Vous aimez organiser et planifier : style="font-size:16px"<br> <br>
			...
			<p>
				<table>
					...
					Vous êtes sérieux et conventionnel : <br> <br>
						<input type="radio" name="q2" value="90"> Tout à fait d'accord<br>
			...
			<p>
				<table>
					...
					Vous vous amusez d’abord et travaillez ensuite : <br> <br>
						<input type="radio" name="q4" value="10"> Tout à fait d'accord<br>
			...
			<p>
				<table>
					...
					Vous n’aimez pas le stress de dernière minute : <br> <br>
						<input type="radio" name="q5" value="90"> Tout à fait d'accord<br>
			...
			<p>
				<table>
					...
					Vous cherchez à comprendre : <br> <br>
						<input type="radio" name="q7" value="10"> Tout à fait d'accord<br>
