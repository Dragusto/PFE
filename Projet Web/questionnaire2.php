	...
	<form enctype="multipart/form-data" action="questionnaire2Traitement.php" method="post">
		...
		<fieldset>
			<p>
				<table>
					<tr>
					Vous vous attachez aux faits et aux détails : style="font-size:16px"<br> <br>
			...
			<p>
				<table>
					...
					Vous vivez dans l’instant présent sans penser aux conséquences futur : <br> <br>
						<input type="radio" name="q3" value="90"> Tout à fait d'accord<br>
		...
		<fieldset>
			<p>
				<table>
					<tr>
					VVous suivez votre instinct : <br> <br>
			...
			<p>
				<table>
					...
					Vous êtes attirés par les idées originales : <br> <br>
						<input type="radio" name="q8" value="10"> Tout à fait d'accord<br>
